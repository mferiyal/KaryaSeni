...
public class DaftarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftaremail = tampilan.findViewById(R.id.editDaftarEmail);
        daftarpass = tampilan.findViewById(R.id.editDaftarPassword);
        buttonSignUp = tampilan.findViewById(R.id.buttonSignUp);
